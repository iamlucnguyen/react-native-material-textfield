...
export default class Label extends PureComponent {
	...
	render() {
		...
		var renderRequired = required ? <Text style={{ color: "red" }}>{" *"}</Text> : null;
		var labelColorStyle = labelColor ? { color: labelColor } : {};
		
		return (
			<Animated.View style={[styles.container, containerStyle]}>
				<Animated.Text style={[styles.text, style, textStyle, labelColorStyle]} {...props}>
					{label}
					{renderRequired}
				</Animated.Text>
			</Animated.View>
